...
var UsersRepository = /** @class */ (function () {
    ...
    UsersRepository.prototype.create = function (_a) {
        var name = _a.name, email = _a.email, answeredQuestions = _a.answeredQuestions, score = _a.score;
    ...
    UsersRepository.prototype.update = function (_a) {
        var id = _a.id, name = _a.name, email = _a.email, answeredQuestions = _a.answeredQuestions, score = _a.score;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
    ...
    UsersRepository.prototype.findAnsweredQuestionsByUser = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
