...
var FindUserByEmailUseCase = /** @class */ (function () {
    function FindUserByEmailUseCase(usersRepository) {
        this.usersRepository = usersRepository;
    }
    FindUserByEmailUseCase.prototype.execute = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!email) {
                            throw new AppError_1.AppError("Invalid email provided");
                        }
