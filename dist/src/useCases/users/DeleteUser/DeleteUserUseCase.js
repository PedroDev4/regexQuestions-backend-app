...
var DeleteUserUseCase = /** @class */ (function () {
    function DeleteUserUseCase(usersRepository) {
        this.usersRepository = usersRepository;
    }
    DeleteUserUseCase.prototype.execute = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!id) {
                            throw new AppError_1.AppError("Invalid identifier");
                        }
                        return [4 /*yield*/, this.usersRepository.findById(id)];
                    case 1:
                        user = _a.sent();
                        if (!user) {
                            throw new AppError_1.AppError("User already does not exists.");
                        }
