...
var CreateUserUseCase = /** @class */ (function () {
    ...
    CreateUserUseCase.prototype.execute = function (_a) {
        var name = _a.name, email = _a.email, _b = _a.answeredQuestions, answeredQuestions = _b === void 0 ? [] : _b, _c = _a.score, score = _c === void 0 ? 0 : _c;
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        if (userExists) {
                            throw new AppError_1.AppError("User \"" + userExists.name + "-" + userExists.email + "\" already exists");
                        }
