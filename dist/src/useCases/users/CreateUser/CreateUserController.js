...
var CreateUserController = /** @class */ (function () {
    ...
    CreateUserController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, email, answeredQuestions, score, createUserUseCase, user;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, name = _a.name, email = _a.email, answeredQuestions = _a.answeredQuestions, score = _a.score;
                        createUserUseCase = tsyringe_1.container.resolve(CreateUserUseCase_1.CreateUserUseCase);
                        return [4 /*yield*/, createUserUseCase.execute({ name: name, email: email, answeredQuestions: answeredQuestions, score: score })];
                    case 1:
                        user = _b.sent();
